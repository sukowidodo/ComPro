				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="canvas-wrapper">
						 <form action="<?php echo base_url();?>adm_book/tambah" method="post" enctype="multipart/form-data">
							<div class="col-lg-6">
								<input class="form-control" placeholder="judul buku" name="judul" required="required">
							</div>
							<div class="col-lg-6">
							...
							<div class="col-lg-12">
								<div class="form-group">
									<textarea  name="deskripsi" id="ckeditor" class="ckeditor" required="required"></textarea>
								</div>
								<div class="form-group">
									<input class="form-control" placeholder="penerbit" name="penerbit" required="required">
								</div>
